                                ...
                                <Row>
                                    ...
                                    <Col span={24} style={{textAlign: "end", borderBottomColor: "red"}}>
                                        <Row align="middle">
                                            <Col span={7} style={{textAlign: "left", border: "1px solid red"}}>
                                                <div className="text-orange-700 text-[10px] p-[1px] text-center"> 7 ngày
                                                    trả hàng
                                                </div>
                                            </Col>
                                            <Col span={17}> <Typography.Text
                                                type="secondary">{formatCurrency(10000)}</Typography.Text></Col>
                                    ...
                                    <Col span={24} style={{textAlign: "end"}}>
                                        <Row justify="space-around" align="top">
                                            ...
                                            <Col span={12}>
                                                <Typography.Text strong type="danger" style={{paddingRight: "5px"}}>Thành
                                                    tiền:</Typography.Text>
                                ...
                                >
                                    <Row>
                                        ...
                                        <Col span={12} style={{textAlign: "end"}}>
                                            <Typography.Text
                                                type="secondary"> {formatCurrency(1200000)}</Typography.Text>
                                        </Col>
                                        <Col span={12}>
                    ...
                    <Col span={24}>
                        <Card bodyStyle={{padding: 0}}>
                            <Row justify="space-between">
                                ...
                                <Col span={12} style={{textAlign: "end"}}><Typography.Text
                                    strong>{uuidv4().slice(0, 20)}</Typography.Text></Col>
                                ...
                                <Col span={12} style={{textAlign: "end"}}>{uuidv4().slice(0, 10)}</Col>
                                <Col span={12}><Typography.Text>Thời gian giao hàng cho vận
                                    chuyển</Typography.Text></Col>
                                <Col span={12} style={{textAlign: "end"}}>{uuidv4().slice(0, 10)}</Col>
                                <Col span={12}><Typography.Text>Thời gian hoàn thành</Typography.Text></Col>
                                <Col span={12} style={{textAlign: "end"}}>{uuidv4().slice(0, 10)}</Col>
                            </Row>
                        </Card>
                    </Col>
