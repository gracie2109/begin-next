...
const DetailProduct: MyPage = () => {
    ...
    const onHandleQuantity = (value: number) => {
                            ...
                            <>
                                ...
                                <div className="my-7">
                                    <Row align="middle" justify="space-between" gutter={[8, 8]}>
                                        ...
                                        <Col span={12}>
                                            <Button size="large" className="w-full bg-salte-100 text-red-600 font-bold border border-red-600 outline-none">{formatWord("mua ngay", "uppercase")}</Button>
                                        </Col>
                                    </Row>
                                </div>
                                <div>
