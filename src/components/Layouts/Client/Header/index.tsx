...
const SearchHome = dynamic(() => import("@/components/features/SearchHome"));
...
const HeaderClient = () => {
    ...
    return (
        <div className='shadow-lg text-black overflow-hidden px-5' style={{ position: 'sticky', top: 0, zIndex: 1, width: '100%', backgroundColor: "white" }}>
